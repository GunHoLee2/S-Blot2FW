...
const GPIO_TypeDef *gp_PORT_MT_CS[]             = {M0_CS_GPIO_Port,     M1_CS_GPIO_Port,      M2_CS_GPIO_Port      };
const uint16_t g_GPIO_Pin_MT_CS[]               = {M0_CS_Pin,            M1_CS_Pin,            M2_CS_Pin            };

const GPIO_TypeDef *gp_PORT_MT_RESET[]          = {M0_STB_RST_GPIO_Port,        M1_STB_RST_GPIO_Port,     M2_STB_RST_GPIO_Port     };
const uint16_t g_GPIO_Pin_MT_RESET[]            = {M0_STB_RST_Pin,              M1_STB_RST_Pin,           M2_STB_RST_Pin           };

const GPIO_TypeDef *gp_PORT_MT_BUSY[]            = {M0_BUSY_SYNC_GPIO_Port,     M1_BUSY_SYNC_GPIO_Port,          M2_BUSY_SYNC_GPIO_Port   };
const uint16_t g_GPIO_Pin_MT_BUSY[]              = {M0_BUSY_SYNC_Pin,           M1_BUSY_SYNC_Pin,                 M2_BUSY_SYNC_Pin         };

const GPIO_TypeDef *gp_PORT_MT_FLAG[]           = {M0_FLAG_GPIO_Port,   M1_FLAG_GPIO_Port,  M1_FLAG_GPIO_Port,   M2_FLAG_GPIO_Port    };
const uint16_t g_GPIO_Pin_MT_FLAG[]             = {M0_FLAG_Pin,    M1_FLAG_Pin,          M2_FLAG_Pin          };
//
const GPIO_TypeDef *gp_PORT_MT_SW[]             = {M0_SW_GPIO_Port,     M1_SW_GPIO_Port,  M2_SW_GPIO_Port    };
const uint16_t g_GPIO_Pin_MT_SW[]               = {M0_SW_Pin,    M1_SW_Pin,          M2_SW_Pin          };
//
const GPIO_TypeDef *gp_PORT_MT_STCK[]            = {M0_STCK_GPIO_Port,M1_STCK_GPIO_Port,  M2_STCK_GPIO_Port    };
const uint16_t g_GPIO_Pin_MT_STCK[]              = {M0_STCK_Pin,    M1_STCK_Pin,          M2_STCK_Pin          };
//
...
/**
  ...
  * @retval None
  */
void dSPIN_Reset_And_Standby(GPIO_TypeDef* GPIOx,uint32_t dwDev_num)
{
#if (defined(STEVAL_PCC009V2) || defined(ST_DSPIN_6470H_DISCOVERY))  
  HAL_GPIO_WritePin(GPIOx, dwDev_num, GPIO_PIN_RESET);
  dSPIN_Delay(10000);
  HAL_GPIO_WritePin(GPIOx, dwDev_num, GPIO_PIN_SET);
