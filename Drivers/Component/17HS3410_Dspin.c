...
const GPIO_TypeDef *gp_PORT_MT_CS[]             = {M0_CS_GPIO_Port,     M2_CS_GPIO_Port      };
const uint16_t g_GPIO_Pin_MT_CS[]               = {M0_CS_Pin,           M2_CS_Pin            };

const GPIO_TypeDef *gp_PORT_MT_RESET[]          = {M0_STB_RST_GPIO_Port,        M2_STB_RST_GPIO_Port     };
const uint16_t g_GPIO_Pin_MT_RESET[]            = {M0_STB_RST_Pin,              M2_STB_RST_Pin           };

const GPIO_TypeDef *gp_PORT_MT_BUSY[]            = {M0_BUSY_SYNC_GPIO_Port,     M2_BUSY_SYNC_GPIO_Port   };
const uint16_t g_GPIO_Pin_MT_BUSY[]              = {M0_BUSY_SYNC_Pin,           M2_BUSY_SYNC_Pin         };

const GPIO_TypeDef *gp_PORT_MT_FLAG[]           = {M0_FLAG_GPIO_Port, M2_FLAG_GPIO_Port    };
const uint16_t g_GPIO_Pin_MT_FLAG[]             = {M0_FLAG_Pin,    M2_FLAG_Pin          };
//
const GPIO_TypeDef *gp_PORT_MT_SW[]             = {M0_SW_GPIO_Port,  M2_SW_GPIO_Port    };
const uint16_t g_GPIO_Pin_MT_SW[]               = {M0_SW_Pin,        M2_SW_Pin          };
//
const GPIO_TypeDef *gp_PORT_MT_STCK[]            = {M0_STCK_GPIO_Port, M2_STCK_GPIO_Port    };
const uint16_t g_GPIO_Pin_MT_STCK[]              = {M0_STCK_Pin,       M2_STCK_Pin          };
//
...
//
//const GPIO_TypeDef *gp_PORT_DRV8825_HOME_SEN[]  = {DRV8825_HOME_X_AXIS_GPIO_Port,DRV8825_HOME_ASP_GPIO_Port,    DRV8825_HOME_TRAY_GPIO_Port     };
//const uint16_t g_GPIO_Pin_DRV8825_HOME_SEN[]    = {DRV8825_HOME_X_AXIS_Pin,     DRV8825_HOME_ASP_Pin,           DRV8825_HOME_TRAY_Pin           };
...
void dSPIN_Reset_And_Standby(uint32_t dwDev_num)
{
  ...
  HAL_GPIO_WritePin((GPIO_TypeDef *)gp_PORT_MT_RESET[dwDev_num],g_GPIO_Pin_MT_RESET[dwDev_num], GPIO_PIN_RESET);
  dSPIN_Delay(10000);
  HAL_GPIO_WritePin((GPIO_TypeDef *)gp_PORT_MT_RESET[dwDev_num], g_GPIO_Pin_MT_RESET[dwDev_num], GPIO_PIN_SET);
...
{
	dSPIN_Set_Param(dwDev_num,dSPIN_ABS_POS, dSPIN_RegsStruct->ABS_POS);
	dSPIN_Set_Param(dwDev_num,dSPIN_EL_POS, dSPIN_RegsStruct->EL_POS);
	dSPIN_Set_Param(dwDev_num,dSPIN_MARK, dSPIN_RegsStruct->MARK);
	dSPIN_Set_Param(dwDev_num,dSPIN_ACC, dSPIN_RegsStruct->ACC);
	dSPIN_Set_Param(dwDev_num,dSPIN_DEC, dSPIN_RegsStruct->DEC);
	dSPIN_Set_Param(dwDev_num,dSPIN_MAX_SPEED, dSPIN_RegsStruct->MAX_SPEED);
	dSPIN_Set_Param(dwDev_num,dSPIN_MIN_SPEED, dSPIN_RegsStruct->MIN_SPEED);
	dSPIN_Set_Param(dwDev_num,dSPIN_FS_SPD, dSPIN_RegsStruct->FS_SPD);
#if defined(L6470)
	dSPIN_Set_Param(dwDev_num,dSPIN_KVAL_HOLD, dSPIN_RegsStruct->KVAL_HOLD);
	dSPIN_Set_Param(dwDev_num,dSPIN_KVAL_RUN, dSPIN_RegsStruct->KVAL_RUN);
	dSPIN_Set_Param(dwDev_num,dSPIN_KVAL_ACC, dSPIN_RegsStruct->KVAL_ACC);
	dSPIN_Set_Param(dwDev_num,dSPIN_KVAL_DEC, dSPIN_RegsStruct->KVAL_DEC);
	dSPIN_Set_Param(dwDev_num,dSPIN_INT_SPD, dSPIN_RegsStruct->INT_SPD);
	dSPIN_Set_Param(dwDev_num,dSPIN_ST_SLP, dSPIN_RegsStruct->ST_SLP);
	dSPIN_Set_Param(dwDev_num,dSPIN_FN_SLP_ACC, dSPIN_RegsStruct->FN_SLP_ACC);
	dSPIN_Set_Param(dwDev_num,dSPIN_FN_SLP_DEC, dSPIN_RegsStruct->FN_SLP_DEC);
	dSPIN_Set_Param(dwDev_num,dSPIN_K_THERM, dSPIN_RegsStruct->K_THERM);
	dSPIN_Set_Param(dwDev_num,dSPIN_STALL_TH, dSPIN_RegsStruct->STALL_TH);
#endif /* defined(L6470) */
#if defined(L6472)
	dSPIN_Set_Param(dwDev_num,dSPIN_TVAL_HOLD, dSPIN_RegsStruct->TVAL_HOLD);
	dSPIN_Set_Param(dwDev_num,dSPIN_TVAL_RUN, dSPIN_RegsStruct->TVAL_RUN);
	dSPIN_Set_Param(dwDev_num,dSPIN_TVAL_ACC, dSPIN_RegsStruct->TVAL_ACC);
	dSPIN_Set_Param(dwDev_num,dSPIN_TVAL_DEC, dSPIN_RegsStruct->TVAL_DEC);
	dSPIN_Set_Param(dwDev_num,dSPIN_T_FAST, dSPIN_RegsStruct->T_FAST);
	dSPIN_Set_Param(dwDev_num,dSPIN_TON_MIN, dSPIN_RegsStruct->TON_MIN);
	dSPIN_Set_Param(dwDev_num,dSPIN_TOFF_MIN, dSPIN_RegsStruct->TOFF_MIN);
#endif /* defined(L6472) */        
        dSPIN_Set_Param(dwDev_num,dSPIN_OCD_TH, dSPIN_RegsStruct->OCD_TH);
	dSPIN_Set_Param(dwDev_num,dSPIN_STEP_MODE, dSPIN_RegsStruct->STEP_MODE);
	dSPIN_Set_Param(dwDev_num,dSPIN_ALARM_EN, dSPIN_RegsStruct->ALARM_EN);
	dSPIN_Set_Param(dwDev_num,dSPIN_CONFIG, dSPIN_RegsStruct->CONFIG);
}
...
void dSPIN_Nop(uint32_t dwDev_num)
{
	...
	dSPIN_Write_Byte(dwDev_num,dSPIN_NOP);
}
...
void dSPIN_Set_Param(uint32_t dwDev_num, dSPIN_Registers_TypeDef param, uint32_t value)
{
	...
	dSPIN_Write_Byte(dwDev_num,(uint8_t)dSPIN_SET_PARAM | (uint8_t)param);
	switch (param)
	{
		case dSPIN_ABS_POS: ;
		case dSPIN_MARK: ;
			/* Send parameter - byte 2 to dSPIN */
			dSPIN_Write_Byte(dwDev_num,(uint8_t)(value >> 16));
		case dSPIN_EL_POS: ;
		case dSPIN_ACC: ;
		case dSPIN_DEC: ;
		...
		case dSPIN_STATUS:
			/* Send parameter - byte 1 to dSPIN */
		   	dSPIN_Write_Byte(dwDev_num,(uint8_t)(value >> 8));
		default:
			/* Send parameter - byte 0 to dSPIN */
		   	dSPIN_Write_Byte(dwDev_num,(uint8_t)(value));
	}
}
...
uint32_t dSPIN_Get_Param(uint32_t dwDev_num,dSPIN_Registers_TypeDef param)
{
	...
	temp = dSPIN_Write_Byte(dwDev_num,(uint8_t)dSPIN_GET_PARAM | (uint8_t)param);
	...
	switch (param)
	{
		...
		case dSPIN_MARK: ;
		case dSPIN_SPEED:
		   	temp = dSPIN_Write_Byte(dwDev_num,(uint8_t)(0x00));
			temp = temp << 16;
			rx |= temp;
		case dSPIN_EL_POS: ;
		case dSPIN_ACC: ;
...
void dSPIN_Run(dSPIN_Direction_TypeDef direction, uint32_t speed,uint32_t dwDev_num)
{
	...
	dSPIN_Write_Byte(dwDev_num,(uint8_t)dSPIN_RUN | (uint8_t)direction);
	/* Send speed - byte 2 data dSPIN */
	dSPIN_Write_Byte(dwDev_num,(uint8_t)(speed >> 16));
	/* Send speed - byte 1 data dSPIN */
	dSPIN_Write_Byte(dwDev_num,(uint8_t)(speed >> 8));
	/* Send speed - byte 0 data dSPIN */
	dSPIN_Write_Byte(dwDev_num,(uint8_t)(speed));
}
...
void dSPIN_Step_Clock(dSPIN_Direction_TypeDef direction, uint32_t dwDev_num)
{
	...
	dSPIN_Write_Byte(dwDev_num,(uint8_t)dSPIN_STEP_CLOCK | (uint8_t)direction);
}
...
void dSPIN_Move(dSPIN_Direction_TypeDef direction, uint32_t n_step, uint32_t dwDev_num )
{
	...
	dSPIN_Write_Byte(dwDev_num,(uint8_t)dSPIN_MOVE | (uint8_t)direction);
	/* Send n_step - byte 2 data dSPIN */
	dSPIN_Write_Byte(dwDev_num,(uint8_t)(n_step >> 16));
	/* Send n_step - byte 1 data dSPIN */
	dSPIN_Write_Byte(dwDev_num,(uint8_t)(n_step >> 8));
	/* Send n_step - byte 0 data dSPIN */
	dSPIN_Write_Byte(dwDev_num,(uint8_t)(n_step));
}
...
void dSPIN_Go_To(uint32_t abs_pos, uint32_t dwDev_num)
{
	...
	dSPIN_Write_Byte(dwDev_num, dSPIN_GO_TO);
	/* Send absolute position parameter - byte 2 data to dSPIN */
	dSPIN_Write_Byte(dwDev_num,(uint8_t)(abs_pos >> 16));
	/* Send absolute position parameter - byte 1 data to dSPIN */
	dSPIN_Write_Byte(dwDev_num,(uint8_t)(abs_pos >> 8));
	/* Send absolute position parameter - byte 0 data to dSPIN */
	dSPIN_Write_Byte(dwDev_num,(uint8_t)(abs_pos));
}
...
void dSPIN_Go_To_Dir(dSPIN_Direction_TypeDef direction, int32_t abs_pos,uint32_t dwDev_num)
{
	...
	dSPIN_Write_Byte(dwDev_num,(uint8_t)dSPIN_GO_TO_DIR | (uint8_t)direction);
	/* Send absolute position parameter - byte 2 data to dSPIN */
	dSPIN_Write_Byte(dwDev_num,(uint8_t)(abs_pos >> 16));
	/* Send absolute position parameter - byte 1 data to dSPIN */
	dSPIN_Write_Byte(dwDev_num,(uint8_t)(abs_pos >> 8));
...
void dSPIN_Go_Until(dSPIN_Action_TypeDef action, dSPIN_Direction_TypeDef direction, uint32_t speed,uint32_t dwDev_num)
{
	...
	dSPIN_Write_Byte(dwDev_num,(uint8_t)dSPIN_GO_UNTIL | (uint8_t)action | (uint8_t)direction);
...
void dSPIN_Release_SW(dSPIN_Action_TypeDef action, dSPIN_Direction_TypeDef direction,uint32_t dwDev_num)
{
	...
	dSPIN_Write_Byte(dwDev_num,(uint8_t)dSPIN_RELEASE_SW | (uint8_t)action | (uint8_t)direction);
}
...
void dSPIN_Go_Home(uint32_t dwDev_num)
{
	...
	dSPIN_Write_Byte(dwDev_num,dSPIN_GO_HOME);
}
...
void dSPIN_Go_Mark(uint32_t dwDev_num)
{
	...
	dSPIN_Write_Byte(dwDev_num,dSPIN_GO_MARK);
}
...
void dSPIN_Reset_Pos(uint32_t dwDev_num)
{
	...
	dSPIN_Write_Byte(dwDev_num,dSPIN_RESET_POS);
}
...
void dSPIN_Reset_Device(uint32_t dwDev_num)
{
	...
	dSPIN_Write_Byte(dwDev_num,dSPIN_RESET_DEVICE);
}
...
void dSPIN_Soft_Stop(uint32_t dwDev_num)
{
	...
	dSPIN_Write_Byte(dwDev_num,dSPIN_SOFT_STOP);
}
...
void dSPIN_Hard_Stop(uint32_t dwDev_num)
{
	...
	dSPIN_Write_Byte(dwDev_num,dSPIN_HARD_STOP);
}
...
void dSPIN_Soft_HiZ(uint32_t dwDev_num)
{
	...
	dSPIN_Write_Byte(dwDev_num,dSPIN_SOFT_HIZ);
}
...
void dSPIN_Hard_HiZ(uint32_t dwDev_num)
{
	...
	dSPIN_Write_Byte(dwDev_num,dSPIN_HARD_HIZ);
}
...
uint16_t dSPIN_Get_Status(uint32_t dwDev_num)
{
	...
	dSPIN_Write_Byte(dwDev_num,dSPIN_GET_STATUS);
...
{
	if(!(HAL_GPIO_ReadPin((GPIO_TypeDef *)gp_PORT_MT_BUSY[dwDev_num], g_GPIO_Pin_MT_BUSY[dwDev_num]))) return 0x01;
	else return 0x00;
}
...
{
	if(!(dSPIN_Get_Status(dwDev_num) & dSPIN_STATUS_BUSY)) return 0x01;
	else return 0x00;
}
...
{
	if(!(HAL_GPIO_ReadPin((GPIO_TypeDef *)gp_PORT_MT_FLAG[dwDev_num], g_GPIO_Pin_MT_FLAG[dwDev_num]))) return 0x01;
	else return 0x00;
}
...
uint8_t dSPIN_Write_Byte(uint32_t dwDev_num,uint8_t byte)
{
  unsigned char asdjklfjasdklfjsdaklfj =0;
    ...
    HAL_GPIO_WritePin((GPIO_TypeDef *)gp_PORT_MT_CS[dwDev_num], g_GPIO_Pin_MT_CS[dwDev_num], GPIO_PIN_RESET);
	/* SPI byte send */
     while(HAL_SPI_GetState(hspi) != HAL_SPI_STATE_READY);
     asdjklfjasdklfjsdaklfj = HAL_SPI_Transmit(hspi, &byte, 1, 500);
    ...
    HAL_GPIO_WritePin((GPIO_TypeDef *)gp_PORT_MT_CS[dwDev_num], g_GPIO_Pin_MT_CS[dwDev_num], GPIO_PIN_SET);
    asdjklfjasdklfjsdaklfj = HAL_SPI_Receive(hspi, &byte, 1, 500);
    if(asdjklfjasdklfjsdaklfj) asdjklfjasdklfjsdaklfj++;
...
void dSPIN_All_Slaves_Set_Param(uint8_t slaves_number, uint8_t *pParam, uint32_t *pValue,uint32_t dwDev_num)
{
  ...
  {
     dSPIN_Write_Daisy_Chain_Bytes(&spiTxBursts[i][0], &spiRxBursts[i][0], slaves_number,dwDev_num);
  }
}
...
void dSPIN_All_Slaves_Registers_Set(uint8_t slaves_number, dSPIN_RegsStruct_TypeDef *dSPIN_RegsStructArray,uint32_t dwDev_num)
{
    ...
    dSPIN_All_Slaves_Set_Param(slaves_number, arrayTxBytes, arrayValues,dwDev_num);
    /* EL_POS */
    for (i=0;i<slaves_number;i++)
    {
...
/**
  ...
  * @retval None
  */
void dSPIN_One_Slave_Move(uint8_t slaves_number, uint8_t slaveNumber, dSPIN_Direction_TypeDef direction, uint32_t n_step,uint32_t dwDev_num)
{
  dSPIN_One_Slave_Send_Command(slaveNumber, slaves_number, (uint8_t)dSPIN_MOVE | (uint8_t)direction, n_step,dwDev_num);
}
...
{
  dSPIN_One_Slave_Send_Command(slaveNumber, slaves_number, (uint8_t)dSPIN_RUN | (uint8_t)direction, speed,dwDev_num);
}
...
uint8_t dSPIN_One_Or_More_Slaves_Busy_SW(uint8_t slaves_number,uint32_t dwDev_num)
{
  uint32_t i;
  uint16_t status;
  dSPIN_All_Slaves_Get_Status(slaves_number, arrayValues,dwDev_num);
  for (i = 0; i < slaves_number; i++)
  {
